...
class ActiveSupport::TestCase
  ...
  def before_setup
    ...
    [
      User, Volunteer, Client, Contact, Profile, Journal, Assignment, Department,
      LanguageSkill, Relative, GroupOffer, GroupAssignment, Feedback, BillingExpense,
      Certificate, GroupAssignmentLog, Hour, Import, Reminder, Manual
    ].each do |model|
