...
ActiveRecord::Schema.define(version: 20170707121930) do
  ...
  create_table "relative_relations", force: :cascade do |t|
    t.string "name"
    t.datetime "deleted_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "relatives", force: :cascade do |t|
    ...
    t.bigint "relative_relations_id"
    t.index ["deleted_at"], name: "index_relatives_on_deleted_at"
    t.index ["relative_relations_id"], name: "index_relatives_on_relative_relations_id"
  ...
  add_foreign_key "relatives", "relative_relations", column: "relative_relations_id"
